export const inp = { width: "100%", background: "#111", border: "1px solid #333", borderRadius: 6, padding: "11px 12px", color: "#e0e0e0", fontSize: ".88rem", outline: "none", boxSizing: "border-box" };
